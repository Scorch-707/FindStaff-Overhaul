      ...
      <body>
        ...
        <div id="wrapper" id="sidebar" style = "">
            ...
            <div id="sidebar-wrapper" style = "background-color: #2ba54b">
              <ul class="sidebar-nav" >
                    ...
                    <div id="collapse2" class="panel-collapse collapse">
                        ...
                        <li>
                           <a href = ""  class = "currency"><i class="fa fa-circle"></i>&nbsp;&nbsp;Currency</a>
                       </li>
                       <li>
                          <a href = ""  class = "banks"><i class="fa fa-circle"></i>&nbsp;&nbsp;Banks</a>
                      </li>
                      <li>
                         <a href = ""  class = "accepted-banks"><i class="fa fa-circle"></i>&nbsp;&nbsp;Accepted Banks</a>
                     </li>
                        <li>
                            ...
                            <div id = "requirementscollapse" class="panel-collapse collapse">
                                ...
                                <li>
                                    <a href = ""  class = "class-arrastre-dc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Job Category</a>
                                </li>
                                <li>
                                    <a href = ""  class = "class-af-fee-lcl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Job Type</a>
                                </li>
                                <li>
                                    <a href = ""  class = "class-af-fee-lcl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Jobs</a>
                                </li>
                                <li>
                                    <a href = ""  class = "class-af-fee-lcl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Fees</a>
                                </li>
                                <li>
                                    <a href = ""  class = "class-af-fee-lcl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Skills</a>
                                </li>
                                <li>
                                    <a href = ""  class = "class-af-fee-lcl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Documents</a>
                                </li>
                            </div>
                  </div>
            <li>
            ...
            <div id="collapse4" class ="panel-collapse collapse">
                <ul class="list-group" style="list-style-type: circle;">
                    <li>
                        <a href = ""  class = "class-setting"><i class="fa fa-circle"></i>&nbsp;&nbsp;Settings</a>
                    </li>
                    <li>
